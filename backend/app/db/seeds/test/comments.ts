...
export const commentsData: Comment[] = [
  ...
  },
  {
    author_id: 2,
    help_request_id: 7,
    created_at: "2024-05-21T15:01:06.763Z",
    description:
      "Sollers auditor ater utpote vulticulus absens. Antea quis vallum somniculosus. Desino demo admoveo comis aestivus capillus somniculosus.",
  },
  {
    author_id: 1,
    help_request_id: 10,
  ...
  },
  {
    ...
    description:
      "Ascit canis defungo harum assumenda doloremque desipio stultus quia voco. Aranea unde fugiat. Ager textor toties subvenio alveus vix tendo solutio tabella volup.",
  },
  {
    author_id: 2,
    help_request_id: 10,
  ...
  },
  {
    author_id: 2,
    help_request_id: 2,
    created_at: "2024-05-22T10:16:34.254Z",
    description:
      "Calcar urbanus adipiscor. Alii vergo quae spes optio casus sumo statua crapula. Circumvenio et totam amor acsi terreo adeptio confero tui.",
  },
  {
    author_id: 1,
    help_request_id: 1,
  ...
  },
  {
    ...
    description:
      "Demo abutor alo vox acerbitas amo quam comparo comitatus. Videlicet vel accusamus amplexus amet. Validus sub thymbra vinum tero.",
  },
];
